...
module.exports = {
    ...
    PSW: process.env.BOT_PASSWORD === undefined ? 'asd123456789asd' : PROCESS.ENV.BOT_PASSWORD,
    ...
    VOICE: process.env.VOICE_REPLY === undefined ? true : convertToBool(process.env.VOICE_REPLY),
    VOICEFILTER: process.env.VOICEFILTER === undefined ? true : process.env.VOICEFILTER,
    ...
    MENU_LOGO: process.env.MENU_LOGO === undefined ?'https://i.ibb.co/0Xzsqf1/In-Shot-20220218-194616984.jpg' : process.env.MENU_LOGO,
