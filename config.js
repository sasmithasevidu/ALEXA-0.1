...
module.exports = {
    ...
    ALL_LINK_BAN: process.env.ALL_LINK_BAN === undefined ? 'true' : process.env.ALL_LINK_BAN,
    ...
    DISSTICKER: process.env.DISABLE_STICKER === undefined ? true : process.env.DISABLE_STICKER,
    ...
    TALKING_PINKY: process.env.TALKING_PINKY === undefined ? 'true' : process.env.TALKING_PINKY,
    ...
    FULL_ALEXA: process.env.FULL_ALEXA === undefined ?'true' : process.env.FULL_ALEXA,
    ...
    EMOJI_WARNING: process.env.EMOJI_WARNING === undefined ? '⚡' : process.env.EMOJI_WARNING,
    ...
    MENU_INFO: process.env.MENU_INFO === undefined ?'🧚‍♂️QUEEN ᴀʟᴇxᴀ ɪꜱ ᴀ ᴘᴏᴡᴇʀꜰᴜʟʟ ʙᴏᴛ ꜰᴏʀ ᴡʜᴀᴛꜱᴀᴘᴘ. ᴅᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ ᴛᴇᴇɴᴜ Use ᴇᴀꜱʏ ᴀɴᴅ ᴡᴏʀᴋɪɴɢ ᴘᴇʀᴇᴄᴛʟʏ..ꜱᴏ QUEEN ᴀʟᴇxᴀ ɪꜱ ʙᴇꜱᴛ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ!!🧚‍' : process.env.MENU_INFO,
    BRANCH: 'main',
    HEROKU: {
